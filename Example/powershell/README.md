# PowerShell Examples - DWG to PDF Conversion
...
|----------|-------------|
| Convert-Basic | Basic DWG to PDF with all settings |
| Convert-ByView | One PDF per view with SetOutColor |
| Convert-Batch | Batch conversion + AddFile/ConvertFiles |
| Convert-Advanced | CTB, scale, ConvertPapers |
| Convert-DWF | DWF to DWG/DXF conversion |
