# C# Examples - DWG to PDF Conversion
...
| Example | Description |
|---------|-------------|
| Example 1 | Basic DWG to PDF with all settings (background color, DPI) |
| Example 2 | One PDF per view with SetOutColor color mapping |
| Example 3 | Batch folder conversion + AddFile/ConvertFiles approach |
| Example 4 | Advanced: CTB, output scale, ConvertPapers |
