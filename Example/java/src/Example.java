...
public class Example {
    ...
    public static void example1_BasicConversion() {
        ...
        try {
            ...
            // Dispatch.put(converter, "DPIWidth", new Variant(300));  // (Optional)
            // Dispatch.put(converter, "DPIHeight", new Variant(300)); // (Optional)
            ...
            Dispatch.put(converter, "nBackgroundColor", new Variant(7)); // White
            ...
            System.err.println("Conversion failed. (Error: " + e.getMessage() + ")");
        } finally {
            obj.safeRelease();
            ComThread.Release();
        }
    ...
    // ============================================================
    // Example 2: One PDF per layout/view (with SetOutColor)
    // ============================================================
    public static void example2_OnePdfPerView() {
        ...
        try {
            ...
            Dispatch.call(converter, "SetOutColor", new Variant(1), new Variant(5)); // Red -> Blue
    ...
    // ============================================================
    // Example 3: Batch conversion (with AddFile + ConvertFiles option)
    // ============================================================
    public static void example3_BatchConversion(String inputDir, String outputDir) {
        ...
        try {
            ...
            // for (File dwgFile : dwgFiles)
            //     Dispatch.call(converter, "AddFile", new Variant(dwgFile.getAbsolutePath()));
            // Dispatch.put(converter, "Width", new Variant(1024));
            // Dispatch.put(converter, "Height", new Variant(768));
            // Dispatch.put(converter, "ColorMode", new Variant(1));
            // Dispatch.call(converter, "ConvertFiles", new Variant(outputDir + "\\batch_output.pdf"));
    ...
    public static void example4_Advanced() {
        ...
        try {
            ...
            Dispatch.call(converter, "SetOutputScale", new Variant(1.0f));
    ...
    // ============================================================
    public static void example5_DWFtoDWG() {
        ...
        try {
            ...
            System.out.println("Converting DWF to DWG...");
            System.out.println("  Input:  " + inputFile);
            System.out.println("  Output: " + outputFile);

            Dispatch.call(converter, "ConvertDWFtoDWGDXF",
                new Variant(inputFile), new Variant(outputFile), new Variant(outVersion));
            System.out.println("Done: " + outputFile);
        } catch (Exception e) {
            System.err.println("Conversion failed. (Error: " + e.getMessage() + ")");
        } finally {
