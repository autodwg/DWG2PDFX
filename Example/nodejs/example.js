...
function example1_BasicConversion() {
    ...
    try {
        ...
        obj.Set("nBackgroundColor", 7); // White background
        // obj.Set("DPIWidth", 300);  obj.Set("DPIHeight", 300); // (Optional)
        ...
        console.error("Conversion failed. (Error:", e.message + ")");
    } finally {
        obj.Close();
    }
}
...
function example2_OnePdfPerView() {
    ...
    try {
        ...
        // Color mapping
        obj.Call("SetOutColor", 1, 5); // Map red to blue
...
function example3_BatchConversion() {
    ...
    try {
        ...
        // --- Alternative: Use AddFile + ConvertFiles ---
        // dwgFiles.forEach(f => obj.Call("AddFile", path.join(inputDir, f)));
        // obj.Set("Width", 1024); obj.Set("Height", 768); obj.Set("ColorMode", 1);
        // obj.Call("ConvertFiles", path.join(outputDir, "batch_output.pdf"));
...
// ============================================================
function example5_DWFtoDWG() {
    const inputFile = "D:\\input\\dwf\\drawing.dwf";
    const outputFile = "D:\\output\\dwg\\output.dwg";
    const outVersion = 24;
    ...
    const obj = createConverter();
    try {
        console.log("Converting DWF to DWG...");
        console.log("  Input: ", inputFile);
        console.log("  Output:", outputFile);

        obj.Call("ConvertDWFtoDWGDXF", inputFile, outputFile, outVersion);
        console.log("Done:", outputFile);
    } catch (e) {
        console.error("Conversion failed. (Error:", e.message + ")");
    } finally {
