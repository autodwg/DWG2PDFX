    ...
    if ($uploadedFile['error'] !== UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($uploadedFile['tmp_name'], $inputPath)) {
            ...
            try {
                ...
                $obj->nBackgroundColor = intval($_POST['background_color'] ?? 7);
            ...
            <div class="card">
                ...
                <div id="settingsPanel">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <label for="background_color">Background Color (ACI)</label>
                            <input type="number" name="background_color" value="7" min="0" max="255" />
                        </div>
                    </div>
