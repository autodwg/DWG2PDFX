...
function example1_basic() {
    ...
    try {
        ...
        // $obj->DPIWidth = 300;  $obj->DPIHeight = 300; // (Optional)
        ...
        echo "Conversion failed. (Error: " . $e->getMessage() . ")\n";
    } finally {
        $obj->Release();
    }
}
...
function example3_batchConversion() {
    ...
    try {
        ...
        // foreach ($dwgFiles as $dwgFile) { $obj->AddFile($dwgFile); }
        // $obj->Width = 1024;  $obj->Height = 768;  $obj->ColorMode = 1;
        // $obj->ConvertFiles($outputDir . "\\batch_output.pdf");
