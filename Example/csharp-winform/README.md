# C# WinForms GUI - DWG to PDF Converter
...
- Select input DWG file and output PDF path
- Color mode, DPI, page size settings
- Background color configuration
- TrueType font output, searchable text options
- Zoom type and layout size options
- Font and PostScript path configuration
